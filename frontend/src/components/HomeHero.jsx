      ...
      <div className="home-hero__content page-container">
        <div className="home-hero__copy">
          ...
          <p className="home-hero__introduction">
            Software should solve a problem—not create one. It should be
            visually refined, intuitive to use, and efficient from the first
            launch.
          </p>
        ...
        <AppGrid className="home-hero__app-grid" />
      </div>
    </section>
  );
}
